...
export default {
  ...
  methods: {
    async fetchCurrentUser() {
      try {
        const response = await fetch('https://module2-project-hmma.onrender.com/current-user');
    ...
    async fetchEmployeeNames() {
      try {
        const response = await fetch('https://module2-project-hmma.onrender.com/leave-requests/employee-names');
    ...
    async fetchLeaveRequests() {
      try {
        const response = await fetch('https://module2-project-hmma.onrender.com/leave-requests');
    ...
    async updateRequest(leaveRequestID, status) {
      try {
        await
          fetch(`https://module2-project-hmma.onrender.com/leave-requests/${leaveRequestID}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
